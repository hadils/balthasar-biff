(ns balthasar
  (:require [com.biffweb :as biff]
            [balthasar.email :as email]
            [balthasar.app :as app]
            [balthasar.home :as home]
            [balthasar.middleware :as mid]
            [balthasar.ui :as ui]
            [balthasar.worker :as worker]
            [balthasar.schema :as schema]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"balthasar.*-test"))
